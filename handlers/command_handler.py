...
from services.notion_service import add_to_todo_database, create_auto_weekly_report
...
def todo_command(update: Update, context: CallbackContext):
    ...
    try:
        ...
        # 添加到 Notion Todo 数据库
        page_id = add_to_todo_database(todo_text)  # noqa: F841
        update.message.reply_text("待办事项已添加到 Notion！")
    except Exception as e:
