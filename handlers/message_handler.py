...
from utils.helpers import extract_links, extract_pdf_text
...
def handle_message(update: Update, context: CallbackContext):
    ...
    try:
        ...
        # 将内容添加到 Notion
        page_id = add_to_notion(message_text, summary, tags, url)  # noqa: F841
        ...
        try:
            ...
            logger.error(f"无法编辑消息：{edit_error}")
