...
from .client import setup_telegram_bot, error_handler
...
from .handlers.url_handlers import (
    handle_url_message, handle_multiple_urls_message
)
from .handlers.pdf_handlers import (
    handle_pdf_document, handle_pdf_url
)
from .handlers.todo_handlers import (
    handle_todo_message
)
from .utils import (
    enrich_analysis_with_metadata, extract_metadata_from_filename,
    prepare_metadata_for_notion
)

# 确保函数被正确导出
__all__ = [
    'setup_telegram_bot', 'start', 'help_command', 'process_message', 
    ...
    'error_handler', 'extract_metadata_from_filename', 'prepare_metadata_for_notion'
]
